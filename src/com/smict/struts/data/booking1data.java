...
public class booking1data {
	public List searchroom_empty (String Tcheck_in,String Tcheck_out,String guest_amount) throws ClassNotFoundException, SQLException{
		...
		while (rs_slide.next()){
			...
			lindex.add(new Booking2Form(room_id,roomtype_id,roomtype_name,roomtype_desc,roomtype_detail,roomtype_single_bed,roomtype_double_bed,roomtype_guest,roomtype_price));
		}
		rs_slide.close();
		stmt.close();
		con.close();
